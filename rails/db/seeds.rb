proteins = Category.create(name: 'Fresh Proteins')
  meats = Category.create(name: 'Meats', parent_id: proteins.id)
    chicken = Category.create(name: 'Chicken', parent_id: meats.id)
    ...
    beef = Category.create(name: 'Beef', parent_id: meats.id)
      beef_steak = Category.create(name: 'Beef Steak', parent_id: beef.id)
      beef_roast = Category.create(name: 'Beef Roast', parent_id: beef.id)
      beef_ground = Category.create(name: 'Ground Beef', parent_id: beef.id)
    turkey = Category.create(name: 'Turkey', parent_id: meats.id)
    ...
    pork = Category.create(name: 'Pork', parent_id: meats.id)
    ...
    buffalo = Category.create(name: 'Buffalo', parent_id: meats.id)
    ...
    lamb = Category.create(name: 'Lamb', parent_id: meats.id)
